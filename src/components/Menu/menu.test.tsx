...
describe('test Menu and MenuItem component in default(horizontal) mode', () => {
  ...
  it('should render correct Menu and MenuItem based on default props', () => {
    ...
    expect(menuElement).toHaveClass('avrora-menu test')
    expect(menuElement.querySelectorAll(':scope > li').length).toEqual(5) //:scope 取得menuElement本身並選擇其下面第一級的li
